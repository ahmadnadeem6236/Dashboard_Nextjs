...
>(({ className, children, ...props }, ref) => (
    ...
    >
        ...
        {''}
        <ChevronDown
            className="relative top-[1px] ml-20 h-4 w-4  transition duration-200 group-data-[state=open]:rotate-180"
            aria-hidden="true"
        />
    </NavigationMenuPrimitive.Trigger>
))
