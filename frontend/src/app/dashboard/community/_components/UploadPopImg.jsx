...
function UploadPopImg({ uploadToggle }) {
        ...
        <div className="fixed px-5 inset-0 z-40 bg-[#00000080]">
            <div className=" h-[437px]  md:max-w-3xl max-w-2xl relative md:left-[414px] top-[110px] z-40">
                <div className=" h-[415px]">
                            ...
                            <div className="relative bottom-5 w-[345px] h-[160px] text-center flex flex-col gap-5">
                                ...
                                <div className="flex flex-col justify-center items-center gap-3">
                                    ...
                                    <p className=" font-interRegular px-1 md:px-0 text-[14px] text-[#999999]">
                                        Works with any .JPG, .PNG, or .GIF file
                                        from the web
                                    </p>
                                    <input
                    ...
                    <button className=" absolute top-[280px] left-[110px] lg:left-[290px] xl:left-[320px] flex justify-center items-center rounded w-[112px] h-[32px] bg-[#FF343E] text-sm font-interSemiBold text-white">
                        Upload file
                    </button>
